...
logger.add(config["Log"]["LogFile"] + 'processing_orders_automatic_cancel.log', level='DEBUG', rotation="1 MB")
           ...
           and not exists (select 1
                           ...
                           select 2
                            ...
                            where m.OrderNumber      = o.EmexOrderID
                              ...
                              and (isnull(m.OrderID, 0) = 0 or m.Quantity <> o.Quantity)
...
for file_row in file_rows:  
    ...
    # with xw.App() as app:
        # wb = app.books.open(os.path.abspath(templateOrderRefusals))
        # sheet = wb.sheets['AnswerCust']
        # sheet = wb.sheets[0] 
