...
//  >Import : http://emexonline.com:3000/MaximaWS/service.asmx?WSDL>0
// Encoding : utf-8
// Version  : 1.0
// (05.08.2023 14:57:29 - - $Rev: 112483 $)
// ************************************************************************ //
...
type
  ...
  ArrayOfDestinations = array of Destinations;   { "http://emexonline.com:3000/MaximaWS/"[GblCplx] }
  ...
  ArrayOfSearchHistory = array of SearchHistory;   { "http://emexonline.com:3000/MaximaWS/"[GblCplx] }
  ...
  ['{D753FD69-9324-1983-728A-70B08B4A46C5}']
    ...
    function  SearchHistory(const Customer: Customer): ArrayOfSearchHistory; stdcall;
    ...
    function  GetCustDestinations(const Customer: Customer; const PriceLogo: string): ArrayOfDestinations; stdcall;
...
const
  defWSDL = 'http://emexonline.com:3000/MaximaWS/service.asmx?WSDL';
  defURL  = 'http://emexonline.com:3000/MaximaWS/Service.asmx';
  defSvc  = 'Service';
  defPrt  = 'ServiceSoap';
var
  RIO: THTTPRIO;
