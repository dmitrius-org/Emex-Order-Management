object EmployeesF: TEmployeesF
  ...
  object pcCommon: TUniPageControl
    ...
    object tabClients: TUniTabSheet
      Hint = ''
      TabVisible = False
  ...
  object qClients: TFDQuery
    ...
    Left = 363
    Top = 270
    object qClientsClientID: TFMTBCDField
      FieldName = 'ClientID'
      Size = 0
    end
    object qClientsBrief: TWideStringField
      FieldName = 'Brief'
      Size = 255
    end
  end
