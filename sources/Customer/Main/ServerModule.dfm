object UniServerModule: TUniServerModule
  ...
  Options = [soRestartSessionOnTimeout, soWipeShadowSessions, soLogSessionCreate, soLogSessionTerminate, soDontCompressDownloads, soTerminateOnSession, soEnableSessionMonitor, soEnableSessionMonitorAdmin]
