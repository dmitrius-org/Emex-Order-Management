...
Select dateadd(dd, 0, p.OperDate) 
  ...
  from (Select cast(GetDate() as Date)	 as OperDate -- ���� ������
              ,c.ClientID
              ...
              ,o.CustomerSubId
              ,o.DetailID
           	  ,sum( iif(o.isCancel=1, 0, 1) *  iif(o.Quantity > 0, o.Quantity, 0)) as Quantity -- ����� ���������� � ���������
         ...
         where c.NotificationMethod = 0 -- �������������� ����������
           and c.ResponseType       = 1 -- ����           
