/*
1. Подключаемся с помощью SQL Server Managment Studio к серверу А

2. Выполняем следующий скрипт:
3. Скрипт создает 2 процедуры. Нам нужна sp_help_revlogin. Выполняем на сервере А эту процедуру:
EXEC sp_help_revlogin
4. Эта процедура создаст нам необходимые скрипты для переноса логинов на другой сервер. Из строк типа
