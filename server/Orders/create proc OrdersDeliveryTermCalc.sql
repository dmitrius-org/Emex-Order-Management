...
/*
  ...
  @IsSave - сохран€ет данные в tOrders
            0 - нет
            1 - да

  ¬ход€щий набор данных: pDeliveryTerm
  –езультат расчета: pDeliveryTerm
*/
go
...
Update p   
   set p.DeliveryPlanDateSupplier  =  case 
                                        when t.DeliveryTerm < 5 -- ¬ прайсах со сроком меньше 5 дней учитывать выходные как не рабочие дни
