...
sgn                     int  sgn -- признак для понимания где сделали insert, текущее максимальное максимальное значение 13                     
------------------------------
pAuditInsert   - Аудит
Flag                    int- 
                         1   - Протокол по клиентскому приложению           
...
Flag                     int  
                           ...
                           2- Пропускаем заказ, Отказались от детали
Tag                      int - дополнительный признак, в часности используется при синхронизации заказов
------------------------------
